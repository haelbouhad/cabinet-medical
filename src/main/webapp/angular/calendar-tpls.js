...
angular.module("template/rcalendar/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rcalendar/month.html",
    ...
    "        </tbody>\n" +
    "    </table>\n" +
    "    <div ng-if=\"showEventDetail\" class=\"event-detail-container\" style=\"margin-top: 15px\">\n" +
    "        <label> Les disponibiltés correspondant au jour choisi (Sélectionner une pour prendre un RDV) </label>"+
    "        <div class=\"scrollable\" >\n" +
